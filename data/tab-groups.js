const TAB_GROUPS = {
  ...
  ibadah: [
    ...
    { id: 'timer',      icon: '⏱️', label: 'Prayer Times' },
    ...
    { id: 'healthlog',  icon: '❤️', label: 'Health' },
  ...
  knowledge: [
    ...
    },
    {
      ...
      tabs: [
        ...
        { id: 'socialmedia', icon: '#️⃣', label: 'Social Media' },
  ...
  library: [
    {
      ...
      tabs: [
        { id: 'umayyads', icon: '🏛️', label: 'Umayyads' }, { id: 'abbasids', icon: '📜', label: 'Abbasids' }, { id: 'andalus', icon: '🏛️', label: 'Andalus' }, { id: 'ottomans', icon: '🕌', label: 'Ottomans' },
    ...
    },
    {
      ...
      tabs: [
        ...
        { id: 'baghdad', icon: '📜', label: 'Baghdad' }, { id: 'cairo', icon: '🏛️', label: 'Cairo' }, { id: 'cordoba', icon: '🏛️', label: 'Cordoba' }, { id: 'istanbul', icon: '🕌', label: 'Istanbul' },
    ...
    },
    {
      ...
      tabs: [
        { id: 'arabicgrammar', icon: '📖', label: 'Grammar' }, { id: 'vocab', icon: '🕌', label: 'Vocab' }, { id: 'rhetoric', icon: '💬', label: 'Rhetoric' }, { id: 'morphology', icon: '🧩', label: 'Morphology' },
        { id: 'pronunciation', icon: '🎤', label: 'Tajweed' }, { id: 'poetry', icon: '🪶', label: 'Poetry' }, { id: 'proverbs', icon: '💡', label: 'Proverbs' }, { id: 'etymology', icon: '🔍', label: 'Etymology' },
    ...
    },
    {
      ...
      tabs: [
        { id: 'epistemology', icon: '🧠', label: 'Epistemology' }, { id: 'ontology', icon: '⚛️', label: 'Ontology' }, { id: 'logic', icon: '🧩', label: 'Logic' }, { id: 'kalam', icon: '💬', label: 'Kalam' },
        { id: 'reason', icon: '💡', label: 'Reason' }, { id: 'freewill', icon: '⚖️', label: 'Free Will' }, { id: 'problemofevil', icon: '☁️', label: 'Prob of Evil' },
