...
const SEASONAL_DQUESTS = [
  { id:'sd1', name:'Taraweeh Prayer', desc:'Complete Taraweeh prayer', xp:75, c: s => s.seasonal?.active === 'ramadan' },
  { id:'sd2', name:'Quran Reading', desc:'Read 1 page of Quran', xp:50, c: s => s.seasonal?.active === 'ramadan' },
