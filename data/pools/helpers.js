...
const _poolTabMap = {
  ...
  HEART_POOL:{cat:'knowledge',tab:'heart'},
  MARRIAGE_POOL:{cat:'knowledge',tab:'marriage'},
  ...
  BATTLES_POOL:{cat:'knowledge',tab:'battles'},
