...
(function() {
  ...
  function mountainSVG(stage, progress) {
    ...
    scene += `<path d="M60 135 Q52 115 55 95 Q58 75 48 58 Q42 42 60 18" fill="none" stroke="#f43f5e" stroke-width="2" stroke-dasharray="4,4" opacity="0.6"/>`;
    scene += `<circle cx="48" cy="${climberY}" r="4" fill="#f43f5e"/>
      <line x1="48" y1="${climberY+4}" x2="48" y2="${climberY+12}" stroke="#f43f5e" stroke-width="2"/>
      <line x1="43" y1="${climberY+8}" x2="53" y2="${climberY+8}" stroke="#f43f5e" stroke-width="2"/>`;
