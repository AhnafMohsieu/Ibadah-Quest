(function() {
  ...
  const SEARCH_POOLS = [
    ...
    { var: 'INSPIRATIONS_POOL', cat: 'Inspirations', tab: 'character-path', fields: ['text','desc','english'] },
    { var: 'SINS_POOL', cat: 'Sins', tab: 'vices-return', fields: ['title','desc','text'] },
    { var: 'FINANCE_POOL', cat: 'Finance', tab: 'finance', fields: ['title','desc'] },
    { var: 'FAMILY_POOL', cat: 'Family', tab: 'family-life', fields: ['title','desc','text'] },
    { var: 'HEART_POOL', cat: 'Heart', tab: 'vices-return', fields: ['title','desc','text','english'] },
    { var: 'PUNISHMENTS_POOL', cat: 'Punishments', tab: 'work-justice', fields: ['title','desc','text'] },
    ...
    { var: 'UMMAH_POOL', cat: 'Ummah', tab: 'community', fields: ['title','desc','text'] },
    { var: 'HAJJ_POOL', cat: 'Hajj', tab: 'worship-rulings', fields: ['title','desc','text'] },
    ...
    { var: 'KNOWLEDGE_POOL', cat: 'Knowledge', tab: 'character-path', fields: ['title','desc','text'] },
    { var: 'JUMUAH_POOL', cat: "Jumu'ah", tab: 'jumuah', fields: ['title','desc','text'] },
    { var: 'MARRIAGE_POOL', cat: 'Marriage', tab: 'family-life', fields: ['title','desc','text'] },
    ...
    { var: 'PATIENCE_POOL', cat: 'Patience', tab: 'virtues', fields: ['title','desc','text'] },
    { var: 'WORK_POOL', cat: 'Work', tab: 'work-justice', fields: ['title','desc','text'] },
    { var: 'COMMUNITY_POOL', cat: 'Community', tab: 'community', fields: ['title','desc','text'] },
    { var: 'ENVIRONMENT_POOL', cat: 'Environment', tab: 'earth-living', fields: ['title','desc','text'] },
    { var: 'TRAVEL_POOL', cat: 'Travel', tab: 'earth-living', fields: ['title','desc','text'] },
    { var: 'FIQH_POOL', cat: 'Fiqh', tab: 'fiqh', fields: ['title','desc','text'] },
    { var: 'ARABIC_POOL', cat: 'Arabic', tab: 'arabic', fields: ['title','desc','text'] },
    { var: 'TAWAKKUL_POOL', cat: 'Tawakkul', tab: 'virtues', fields: ['title','desc','text'] },
    { var: 'IKHLAS_POOL', cat: 'Ikhlas', tab: 'virtues', fields: ['title','desc','text'] },
    { var: 'ZUHD_POOL', cat: 'Zuhd', tab: 'character-path', fields: ['title','desc','text'] },
    { var: 'DAWAH_POOL', cat: "Da'wah", tab: 'service', fields: ['title','desc','text'] },
    ...
    { var: 'PARENTING_POOL', cat: 'Parenting', tab: 'family-life', fields: ['title','desc','text'] },
    { var: 'FOOD_POOL', cat: 'Food', tab: 'earth-living', fields: ['title','desc','text'] },
    { var: 'TIBB_POOL', cat: 'Tibb', tab: 'wellness', fields: ['title','desc','text'] },
    { var: 'YOUTH_POOL', cat: 'Youth', tab: 'youth-tech', fields: ['title','desc','text'] },
    { var: 'TECH_POOL', cat: 'Technology', tab: 'youth-tech', fields: ['title','desc','text'] },
    { var: 'NEIGHBORS_POOL', cat: 'Neighbors', tab: 'community', fields: ['title','desc','text'] },
  ];
  ...
  // core/actions.js is NOT deferred, so its boot-time initSearch() call runs
  // before this deferred script defines us — self-initialize instead.
  // (Guarded: node test sandboxes have no document.)
