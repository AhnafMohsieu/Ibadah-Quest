// src/core/recovery.js — ESM port of core/recovery.js (corruption detection, quarantine, salvage).
// Converted from the legacy IIFE plus window-publish shape to ESM exports only.
// Logic untouched; the IIFE wrapper was removed because `export` must be top-level.
