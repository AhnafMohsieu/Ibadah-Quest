...
const TAB_SCRIPTS = {
  ...
  seerah: ['render/static.js'], sahaba: ['render/static.js'],
  prophets: ['render/static.js'], women: ['render/static.js'],
...
function fireRenderers(tabId) {
  const RENDERERS = {
    ...
    seerah: 'renderSeerah', sahaba: 'renderSahaba',
    prophets: 'renderProphets', women: 'renderWomen',
